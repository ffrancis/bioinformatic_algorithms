...
input_file  = 'Tm_values_gapped_only.txt'
...
axScatter.set_xlim((min_Tm-50, max_Tm+50))
axScatter.set_ylim((min_Tm-50, max_Tm+50))
...
axHistx.set_ylim(0,700)

axHisty.set_xlim(0,700)
